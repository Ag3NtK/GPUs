...
__global__ void transpose_v1 ( float * in , float * out , int n )
{
...
int main(int argc, char **argv)
{
    ...
    dim3 dimBlock(NTHREADS2D, NTHREADS2D); // Bloque de 16 * 16 = 256 hilos en 2D
    ...
    // TODO: launch kernel
    transpose_v1 <<<dimGrid, dimBlock>>> (d_in, d_out, n);
    // TODO: synchronize
